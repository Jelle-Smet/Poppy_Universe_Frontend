  ...
  <div class="dashboard-container">
    <div class="glass-header">
      <div class="header-main-content">
        <h1 class="main-glow-title">Poppy’s Matrix Booster</h1>
        <div class="layer-badge secondary">LAYER 3 — CATEGORY-LEVEL PERSONALIZATION</div>
      </div>

      <div class="intro-box trend-style">
        <p class="intro-main">
          Layer 3 is the <strong>category-based personalization layer</strong>. Instead of focusing on individual objects,
          it learns patterns in the <strong>types of celestial objects</strong> you tend to prefer.
        </p>

        <div class="intro-details">
          <p>
            This layer applies <strong>matrix factorization</strong> to a
            <strong>User × Category interaction matrix</strong>, capturing latent preferences for
            star types, planet classes, and moon systems.  
            It predicts how likely you are to enjoy <em>categories you haven’t interacted with yet</em>,
            based on similarities to past behavior.
          </p>

          <p>
            The resulting scores are used as a <strong>ranking signal</strong> that refines recommendations
            and can be passed to higher layers for further modeling — without directly overriding earlier
            visibility or rule-based constraints.
          </p>

          <p class="visibility-note">
            <strong>Visibility percentages</strong> are inherited from Layer 1 and remain
  ...
  setup() {
    ...
    const fetchRecommendations = async () => {
        try {
            ...
            const res = await axiosWithAuth.post('/api/engine/run-l1-l3', payload); // ✅ Fixed endpoint
    ...
    const syncAndFetch = () => {
        router.push({ 
            path: '/Layer3_Recommendations',  // ✅ FIXED: Use Layer 3's path
            query: { 
            ...route.query, 
