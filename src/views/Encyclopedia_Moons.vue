<template>
  <div class="encyclopedia-container">
    <h1>🌙 Moon Encyclopedia</h1>
    <p class="intro">
      Explore the natural satellites orbiting the worlds of our Solar System. 
      Each glowing orb represents the moon’s distinct color and atmosphere.
    </p>
