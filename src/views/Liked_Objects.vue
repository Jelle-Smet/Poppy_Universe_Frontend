...
h1 { font-size: 2.5rem; margin: 0; text-shadow: 0 0 15px rgba(125, 95, 255, 0.7); }
.intro { color: rgba(180, 160, 255, 0.8); font-weight: 600; margin-top: 10px; }
...
.loading-state, .empty-msg { margin-top: 50px; text-align: center; opacity: 0.6; }
</style>