  ...
  <div class="dashboard-container">
    <div class="glass-header">
      <div class="header-main-content">
        ...
        <p class="intro-main">
            Layer 5 is the <strong>consensus-based fusion layer</strong>. It produces the final
            recommendation ranking by intelligently combining the outputs of all previous layers.
        </p>

        <div class="intro-details">
            <p>
            This layer applies a <strong>genetic algorithm</strong> to optimize how rankings from
            personalization, trend analysis, matrix factorization, and neural networks are weighted.
            Each object is evaluated across all layers, ensuring no single strategy dominates unfairly.
            </p>

            <p>
            The algorithm evolves weight combinations over multiple generations to
            <strong>minimize disagreement</strong> between layer rankings. Separate optimizations are
            performed for stars, planets, and moons, allowing each object type to benefit from the
            most reliable signals.
            </p>

            <p class="visibility-note">
            <strong>Visibility percentages</strong> and observability explanations are inherited from
            earlier layers and remain <em>informational only</em>. Final rankings may optionally be
            filtered or sorted by visibility for real-time observation planning.
            </p>
        </div>
        </div>
      ...
      <div class="dashboard-grid">
        ...
        >
          <div class="metrics-container">
            ...
            <div v-if="item.GA_Rank" class="boost-badge-glow">
                #{{ item.GA_Rank }} <span>RANK</span> 
            </div>
          </div>
          ...
          <div class="card-content">
            ...
            <div class="info">
              ...
              <div v-if="item.Rank_Summary" class="fusion-summary">
                    <span class="label">Fusion Trace:</span>
                    <p class="summary-text">{{ item.Rank_Summary }}</p>
                </div>
        ...
        try {
            ...
            const processItems = (items, type) => (items || []).map(item => {
                ...
                return { 
                    ...
                    // We keep Boost for logic but primarily focus on GA_Rank now
                    GA_Rank: item.GA_Rank || null,
